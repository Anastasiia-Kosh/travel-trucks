...
export const fetchCampers = async (
  ...
  const response = await nextServerInstance.get<FetchCampersResponse>(
    "/catalog",
    {
      params,
    },
...
export const fetchCamperFilters = async (): Promise<CamperFiltersResponse> => {
  const response =
    await nextServerInstance.get<CamperFiltersResponse>("/catalog/filters");
  return response.data;
};
...
export const fetchCamperById = async (
  ...
  const response = await nextServerInstance.get<CamperDetails>(
    `/catalog/${camperId}`,
  );
  return response.data;
};
...
export const fetchCamperReviews = async (
  ...
  const response = await nextServerInstance.get<CamperReview[]>(
...
export const createBookingRequest = async (
  ...
  const res = await nextServerInstance.post<BookingResponse>(
    `/catalog/${camperId}/booking-requests`,
    data,
  );
  return res.data;
};

        ...
        {sortedGallery.map((image, index) => (
          <SwiperSlide key={image.id} className={css.mainSlide}>
            <Image
              ...
              fill
              sizes="(min-width: 1440px) 638px, (min-width: 824px) 760px, (min-width: 768px) calc(100vw - 64px), calc(100vw - 40px)"
        ...
        {sortedGallery.map((image, index) => (
          <SwiperSlide key={image.id} className={css.thumbSlide}>
            <Image
              ...
              fill
              sizes="(min-width: 1440px) 136px, (min-width: 768px) 172px, 42vw"
              loading={index === 0 ? "eager" : "lazy"}
              fetchPriority={index === 0 ? "high" : "auto"}
              className={css.image}
            />
